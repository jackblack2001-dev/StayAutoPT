    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="btn btn-outline-danger float-right" data-toggle="modal" data-target="#ModalRemoveCar" data-dismiss="modal">Remover <i class="fa fa-trash"></i></button>
            </div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <?php if (isset($_SESSION['Id'])) : ?>
            ...
            <?php else : ?>
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Para Usar esta funcionalizade tem que Ativar a sua conta</h4>
                    </div>
                    <div class="modal-body">
                        <p class="text-center">
                            <h4><small>Para poder enviar uma mensagem ao dono deste carro, têm que ativar a sua conta primeiro</small></h4>
                        </p>
                    </div>
                    <div class="modal-footer">
                        <a class="btn btn-outline-primary" href="../User/Profile.php">Ativar Conta</a>
                    </div>
                </div>
            <?php endif ?>
        <?php endif ?>
...
<div id="ModalRemoveCar" class="modal fade" role="dialog">
    <div class="modal-dialog">

        <div class="modal-content">
            <div class="modal-header">
                <h4 style="color: red;"><strong><i class="fa fa-warning"></i> Atenção <i class="fa fa-warning"></i></strong></h4>
            </div>
            <div class="modal-body">
                <p class="text-center">
                    <h5>Esta ação é irreversivel, pretende continuar?</h5>
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-success" data-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-outline-danger" data-dismiss="modal" onclick="RemoveCar()">Remover</button>
            </div>
        </div>
